...
bash <(curl -sL https://github.com/xiaomi-sweet2/scripts/raw/refs/heads/14.0/alphadroid/repo-sync.sh) && \
bash <(curl -sL https://github.com/xiaomi-sweet2/scripts/raw/refs/heads/14.0/alphadroid/build.sh) && \
bash <(curl -sL https://github.com/xiaomi-sweet2/scripts/raw/refs/heads/14.0/alphadroid/upload.sh)
